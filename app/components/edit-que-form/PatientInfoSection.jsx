...
// Displays and manages patient basic information
    ...
    <>
      ...
      <div className="mb-4">
        ...
        <textarea
          ...
          onChange={(e) => onInputChange(e, "medical_history")}
          className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
          rows="3"
        ...
        {formData.medications.map((med, index) => (
          <div key={index} className="flex gap-2 mb-2">
            <input
              type="text"
              value={med}
              onChange={(e) => onMedicationChange(index, e.target.value)}
              className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
            ...
            {formData.medications.length > 0 && (
              <button
                ...
                className="bg-red-500 hover:bg-red-700 text-white py-2 px-3 rounded focus:outline-none focus:shadow-outline text-xs"
              >
                Remove
              </button>
            )}
