  ...
  return (
    <div className="mb-4">
      ...
      <div className="mb-4">
        ...
        <select
          value={queueData.visit_type}
          onChange={(e) => onQueueChange("visit_type", e.target.value)}
      ...
      <div className="mb-4">
        ...
        <select
          ...
          onChange={(e) => onQueueChange("status", e.target.value)}
          className="shadow border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
        >
      ...
      <div className="mb-4">
        ...
        <div className="bg-gray-100 p-3 rounded border">
          <p className="text-sm">
            <span className="font-medium">Lic #:</span> {lic || "N/A"}
          </p>
          <p className="text-sm">
            <span className="font-medium">PTR #:</span> {ptr || "N/A"}
          </p>
          <p className="text-sm">
            <span className="font-medium">S2 #:</span> {s2 || "N/A"}
          </p>
        </div>
      </div>
