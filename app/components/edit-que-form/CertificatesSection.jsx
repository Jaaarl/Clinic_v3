...
// Manages medical certificate items
    ...
    <div className="mb-6">
      ...
      {certificates.map((cert, index) => (
        <div key={index} className="border rounded p-3 mb-2">
          ...
          <textarea
            value={cert.diagnosis}
            onChange={(e) => onCertificateChange(index, "diagnosis", e.target.value)}
          ...
          />
          <textarea
            value={cert.recommendation}
            onChange={(e) => onCertificateChange(index, "recommendation", e.target.value)}
