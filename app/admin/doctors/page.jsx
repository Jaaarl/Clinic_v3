    ...
    try {
      ...
      if (res.ok) {
        ...
        const refreshRes = await fetch(
          `/api/doctors/${selectedDoctor._id}/schedule`,
        );
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setDoctorForm({ ...doctorForm, lic: e.target.value })
                    }
                    className="w-full border rounded px-3 py-2"
                  />
                </div>
                <div className="mb-4">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setDoctorForm({ ...doctorForm, ptr: e.target.value })
                    }
                    className="w-full border rounded px-3 py-2"
                  />
                </div>
                <div className="mb-4">
                  ...
                  <input
                    ...
                    value={doctorForm.s2}
                    onChange={(e) =>
                      setDoctorForm({ ...doctorForm, s2: e.target.value })
                    }
                    className="w-full border rounded px-3 py-2"
                  />
                </div>
