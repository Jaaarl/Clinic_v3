...
export const appointmentService = {
  ...
  async createAppointment(data) {
    ...
    // Check if slot is available (not already booked by THIS patient)
    // Different patients can have appointments at the same time with the same doctor
    ...
    if (existing) {
      throw new Error("This patient already has an appointment at this time slot");
    }
