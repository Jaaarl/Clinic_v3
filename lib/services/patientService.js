...
export const patientService = {
  ...
  async updatePatient(id, data) {
    ...
    const { name, birthday, gender, contact, medical_history, medications, visit_history } = data;
    ...
    const updatedPatient = await Patient.findByIdAndUpdate(
      id,
      { name, birthday, gender, contact, medical_history, medications, visit_history },
